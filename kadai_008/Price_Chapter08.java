...
public static void main(String[] args) {
  ...
  switch(agePrice) {
      case 1:
          ...
          if(price.equals("1000円")) {
        }
        break;
      case 2:
        System.out.println("20代の料金は2000円");
        if(price.equals("2000円")) {
        }
        break;
      case 3:
        System.out.println("30代の料金は3000円");
        if(price.equals("3000円")) {
        }
        break;
      case 4:
        System.out.println("40代の料金は4000円");
        if(price.equals("4000円")) {
        }
        break;
      case 5:
        System.out.println("50代の料金は5000円");
        if(price.equals("5000円")) {
        }
        break;
      case 6:
        System.out.println("60代の料金は6000円");
        if(price.equals("6000円")) {
        }
        break;
      case 7:
        System.out.println("70代の料金は7000円");
        if(price.equals("7000円")) {
        }
        break;
      case 8:
        System.out.println("10代の料金は8000円");
        if(price.equals("8000円")) {
        }
          break;
      default:
